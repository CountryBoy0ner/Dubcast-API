...
public class SoundCloudRadioProgrammingServiceImpl implements RadioProgrammingService {
    ...
    public PlaylistScheduleResponse appendPlaylistToSchedule(Long playlistId) {
        ...
        List<ScheduleEntryDto> entries =
                scheduleEntryService.appendPlaylistToTail(playlistId);
    ...
    @Override
    @Transactional
    public AdminScheduleSlotDto insertTrackIntoDay(LocalDate date,
                                                   Long trackId,
                                                   int position) {
    ...
    private AdminScheduleSlotDto toAdminSlotDto(ScheduleEntryDto se,
                                                Map<Long, String> playlistNamesCache) {
        ...
        if (playlistId != null) {
            if (playlistNamesCache != null && playlistNamesCache.containsKey(playlistId)) {
                ...
                playlistName = playlistRepository.findById(playlistId)
