...
public class UserServiceImpl implements UserService {
  ...
  public UserDto getById(UUID id) {
    User user =
        userRepository.findById(id).orElseThrow(() -> NotFoundException.of("User", "id", id));
  ...
  public UserProfileResponse getCurrentUserProfile() {
    ...
    return UserProfileResponse.builder().username(user.getUsername()).bio(user.getBio()).build();
  }

  @Override
  public UserProfileResponse getCurrentUserProfileByUsername(String username) {

    User user =
        userRepository
            .findByUsername(username)
            .orElseThrow(() -> NotFoundException.of("User", "username", username));
