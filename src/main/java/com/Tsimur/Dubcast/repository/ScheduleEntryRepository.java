...
public interface ScheduleEntryRepository extends JpaRepository<ScheduleEntry, Long> {
  ...
  @Query(
      """
            ...
            where e.startTime < :end
              and e.endTime > :start
            """)
  boolean existsOverlap(@Param("start") OffsetDateTime start, @Param("end") OffsetDateTime end);
  ...
  @Query(
      """
            ...
            """)
  void deleteByPlaylistIdAndStartTimeAfter(
      @Param("playlistId") Long playlistId, @Param("from") OffsetDateTime from);
