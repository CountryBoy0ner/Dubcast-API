...
@Tag(
    name = "Tracks (Admin)",
    description =
        "CRUD endpoints for managing tracks in the system. Intended for admin/back-office usage.")
...
public class TrackRestController {
  ...
  public ResponseEntity<TrackDto> create(
      @Valid @RequestBody @Parameter(description = "Track payload to create") TrackDto dto) {
  ...
  public ResponseEntity<TrackDto> getById(
      @PathVariable @Parameter(description = "Track ID", example = "42") Long id) {
  ...
  public ResponseEntity<TrackDto> update(
      @PathVariable @Parameter(description = "Track ID to update", example = "42") Long id,
      @Valid @RequestBody @Parameter(description = "Updated track data") TrackDto dto) {
  ...
  public ResponseEntity<Void> delete(
      @PathVariable @Parameter(description = "Track ID to delete", example = "42") Long id) {
