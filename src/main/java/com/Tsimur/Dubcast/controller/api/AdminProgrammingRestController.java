...
public class AdminProgrammingRestController {
    ...
    public ResponseEntity<Void> deleteSlot(
            @Parameter(description = "Schedule slot ID", example = "123")
    ...
    public ResponseEntity<AdminScheduleSlotDto> insertTrackIntoDay(
            ...
            @Parameter(description = "Track ID to insert", example = "42")
            @RequestParam Long trackId,

            @Parameter(
                    description = "Zero-based position in the day schedule",
                    example = "0"
            )
    ...
    public ResponseEntity<AdminScheduleSlotDto> changeTrack(
            ...
            @Parameter(description = "New track ID", example = "99")
            @RequestParam Long trackId
    ) {
    ...
    public ResponseEntity<Void> reorderDay(
            ...
            @Parameter(
                    description = "List of slot IDs in the desired order",
                    example = "[10, 11, 5, 7]"
            )
    ...
    @Operation(
            ...
            description = "Appends all tracks from the specified playlist to the end of the current radio schedule.",
            responses = {
                    @ApiResponse(
                            responseCode = "200",
    ...
    public ResponseEntity<PlaylistScheduleResponse> appendPlaylistToSchedule(
            @Parameter(description = "Playlist ID", example = "5")
