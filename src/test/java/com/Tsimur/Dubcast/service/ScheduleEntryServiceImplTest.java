 ...
 *
 * We mock repositories, mapper and event publisher.
 * RadioTimeConfig is real (fixed timezone for deterministic tests).
 */
...
class ScheduleEntryServiceImplTest {
    ...
    void setUp() {
        ...
        this.service = new ScheduleEntryServiceImpl(
    ...
    void create_shouldSaveAndReturnDto() {
        ScheduleEntryDto input = ScheduleEntryDto.builder()
        ...
        ScheduleEntryDto output = ScheduleEntryDto.builder()
                .id(1L)
                .build();
    ...
    void update_shouldUpdateAndReturnDto_whenExists() {
        ...
        ScheduleEntryDto patch = ScheduleEntryDto.builder()
                .id(999L) // ignored in mapper
                .build();

        ScheduleEntry saved = new ScheduleEntry();
        saved.setId(id);
        ScheduleEntryDto resultDto = ScheduleEntryDto.builder()
                .id(id)
                .build();
    ...
    void update_shouldThrow_whenNotFound() {
        ...
        assertThrows(NotFoundException.class, () -> service.update(1L, ScheduleEntryDto.builder().build()));
    }
    ...
    void getDay_shouldUseConfiguredZoneAndReturnList() {
        ...
        verify(scheduleEntryRepository)
                .findByStartTimeBetweenOrderByStartTime(any(OffsetDateTime.class), any(OffsetDateTime.class));
    }
    ...
    void getDayPage_shouldDelegateToRangePage() {
        ...
        when(scheduleEntryRepository.findPageByStartTimeBetweenOrderByStartTime(any(), any(), eq(pageable)))
                .thenReturn(page);
        when(scheduleEntryMapper.toDto(e1)).thenReturn(d1);
