...
class TrackServiceImplTest {
    ...
    void getAll_shouldReturnMappedList() {
        ...
        TrackDto d1 = TrackDto.builder().id(1L).soundcloudUrl("url1").title("t1").durationSeconds(100).build();
        TrackDto d2 = TrackDto.builder().id(2L).soundcloudUrl("url2").title("t2").durationSeconds(200).build();
