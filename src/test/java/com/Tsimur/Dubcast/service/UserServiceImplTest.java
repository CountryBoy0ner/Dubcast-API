...
class UserServiceImplTest {
  ...
  void create_shouldCreateUser_whenEmailNotExists() {
    UserDto requestDto = UserDto.builder().email("test@example.com").role("ROLE_USER").build();
  ...
  void create_shouldThrow_whenEmailAlreadyExists() {
    UserDto dto = UserDto.builder().email("test@example.com").role("ROLE_USER").build();

    when(userRepository.existsByEmail("test@example.com")).thenReturn(true);

    assertThrows(IllegalArgumentException.class, () -> userService.create(dto, "pass"));
  ...
  void getById_shouldReturnUser_whenFound() {
    ...
    UserDto dto = UserDto.builder().id(id).email("u@example.com").role("ROLE_USER").build();
  ...
  void update_shouldUpdate_whenEmailNotChangedOrFree() {
    ...
    UserDto dto = UserDto.builder().email("new@example.com").role("ROLE_ADMIN").build();
    ...
    UserDto resultDto =
        UserDto.builder().id(id).email("new@example.com").role("ROLE_ADMIN").build();
